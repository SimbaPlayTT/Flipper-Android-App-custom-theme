...
internal fun FlipperPallet.toAnimatePallet() = FlipperPallet(
    ...
    dPadAccent = animateColor(dPadAccent),
    actionOnFlipperSubGhzEnable = animateColor(actionOnFlipperSubGhzEnable),
    actionOnFlipperSubGhzProgress = animateColor(actionOnFlipperSubGhzProgress),
    actionOnFlipperInfraredEnable = animateColor(actionOnFlipperInfraredEnable),
    actionOnFlipperInfraredProgress = animateColor(actionOnFlipperInfraredProgress),
    shareSheetBackgroundAction = animateColor(shareSheetBackgroundAction),
    flipperScreenColor = animateColor(flipperScreenColor)
)
