...
data class FlipperPallet(
    ...
    val dPadAccent: Color = accent,
    val actionOnFlipperSubGhzEnable: Color = accent,
    val actionOnFlipperSubGhzProgress: Color = Color(0xFFFEA64B),
    val actionOnFlipperInfraredEnable: Color = accent,
    val actionOnFlipperInfraredProgress: Color = Color(0xFFFEA64B),
    val shareSheetBackgroundAction: Color = accent,
