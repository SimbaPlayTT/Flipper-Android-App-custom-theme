...
class StreamingRepository(
    ...
    @Volatile
    private var screenBackgroundColorArgb: Int = DEFAULT_SCREEN_BACKGROUND_COLOR
    ...
    private suspend fun onStreamFrameReceived(
        ...
        val screen = ScreenStreamFrameDecoder.decode(streamFrame, screenBackgroundColorArgb) ?: run {
    ...
    init {
        settings.data
            .onEach { settings ->
                screenBackgroundColorArgb = if (settings.custom_accent_theme_enabled) {
                    hsbToColor(
